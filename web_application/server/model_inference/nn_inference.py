...
# set model path
XGB_MODEL_PATH = '/Users/elijahflomen/Desktop/Capstone/ocean-app-api/model_files/xgb_11.model'
NN_MODEL_PATH = '/Users/elijahflomen/Desktop/Capstone/ocean-app-api/model_files/nn_1281283'
SCALER_PATH = '/Users/elijahflomen/Desktop/Capstone/ocean-app-api/model_files/ss_11.pkl'
KNN_PATH = '/Users/elijahflomen/Desktop/Capstone/ocean-app-api/model_files/knearestneighbors_cluster_classification_simple.pkl'
...
def run_inf_model(date, lat, lon, sst, chlor, par, pic, aph):
    model = ChlaPredictor(XGB_MODEL_PATH, NN_MODEL_PATH, SCALER_PATH, KNN_PATH)
    model_inp = np.array([[
        lat, 
        lon, 
        date,
    ...
    preds = model.make_inference(model_inp)
    return preds[0]
